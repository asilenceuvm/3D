...
public class ImageManager {
    ...
    private BufferedImage tile1, tile2, tile3, tile4, tile5;
    private BufferedImage cubeEnemy, cubeEnemy2;
    ...
    public ImageManager(){
        ...
        tile5 = ImageLoader.loadImage("tile5.png");
        
        cubeEnemy = ImageLoader.loadImage("cubeEnemy.png");
        cubeEnemy2 = ImageLoader.loadImage("cubeEnemy2.png");
    ...
    public BufferedImage getImage(String image){
        ...
        else if(image.equals("tile5")){
            returnImage = tile5;
        }
        else if(image.equals("cubeEnemy")){
            returnImage = cubeEnemy;
        }
        else if(image.equals("cubeEnemy2")){
            returnImage = cubeEnemy2;
        }
