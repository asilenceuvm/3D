...
public class RectangularPrism extends Shape{
    ...
    public RectangularPrism(Main main, PolygonManager polygonManager, Camera camera, double x, double y, double z, 
            double xSideLength, double ySideLength, double zSideLength, BufferedImage texture){
        ...
        polys[1] = new PolygonObject(main, camera, new double[]{corners[0][0], corners[1][0], corners[5][0], corners[4][0]},
        ...
        polys[2] = new PolygonObject(main, camera, new double[]{corners[4][0], corners[5][0], corners[6][0], corners[7][0]},
        ...
        polys[3] = new PolygonObject(main, camera, new double[]{corners[1][0], corners[2][0], corners[6][0], corners[5][0]},
        ...
        polys[4] = new PolygonObject(main, camera, new double[]{corners[2][0], corners[3][0], corners[7][0], corners[6][0]},
        ...
        polys[5] = new PolygonObject(main, camera, new double[]{corners[0][0], corners[4][0], corners[7][0], corners[3][0]},
    ...
    public RectangularPrism(Main main, PolygonManager polygonManager, Camera camera, double x, double y, double z, 
            double xSideLength, double ySideLength, double zSideLength, BufferedImage texture, BufferedImage texture2){
        super(main, polygonManager, camera,x,y,z);
        ...
        polys[0] = new PolygonObject(main, camera, new double[]{corners[0][0], corners[1][0], corners[2][0], corners[3][0]},
            new double[]{corners[0][1], corners[1][1], corners[2][1], corners[3][1]}, 
                new double[]{corners[0][2], corners[1][2], corners[2][2], corners[3][2]}, texture2, "-z");
        ...
        polys[2] = new PolygonObject(main, camera, new double[]{corners[4][0], corners[5][0], corners[6][0], corners[7][0]},
            new double[]{corners[4][1], corners[5][1], corners[6][1], corners[7][1]}, 
                new double[]{corners[4][2], corners[5][2], corners[6][2], corners[7][2]}, texture2, "+z");
        
        polys[3] = new PolygonObject(main, camera, new double[]{corners[1][0], corners[2][0], corners[6][0], corners[5][0]},
            new double[]{corners[1][1], corners[2][1], corners[6][1], corners[5][1]}, 
                new double[]{corners[1][2], corners[2][2], corners[6][2], corners[5][2]}, texture2, "-x");
        
        polys[4] = new PolygonObject(main, camera, new double[]{corners[2][0], corners[3][0], corners[7][0], corners[6][0]},
            new double[]{corners[2][1], corners[3][1], corners[7][1], corners[6][1]}, 
                new double[]{corners[2][2], corners[3][2], corners[7][2], corners[6][2]}, texture2, "-y");
        
        polys[5] = new PolygonObject(main, camera, new double[]{corners[0][0], corners[4][0], corners[7][0], corners[3][0]},
            new double[]{corners[0][1], corners[4][1], corners[7][1], corners[3][1]}, 
                new double[]{corners[0][2], corners[4][2], corners[6][2], corners[3][2]}, texture2, "+x");
